...
# Pacotes basicos + ambiente grafico minimo + dependencias do Postman
RUN apt-get update && apt-get install -y \
 ...
 && curl -fsSL "https://dl.pstmn.io/download/version/${POSTMAN_VERSION}/linux64" -o /tmp/postman.tar.gz \
